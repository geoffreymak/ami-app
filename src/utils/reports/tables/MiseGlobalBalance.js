...
const createRowFooter = (data, dates, transCategory) => {
  const filtredMise = sortTransactions(
    filterTransactions(mergreMise(data), dates, 'addDate'),
    'asc',
  ...
  return `
    <tr>
      <td class="tg-l470" colspan="3">
        <span style="font-weight:800;font-style:normal;font-size:11pt;">
          Total/Periodique
        </span>
      </td>
      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${!!data ? getFormatedNumber(mergeMiseSolde(filtredMise)[0]) : ''}
        </span>
      </td>
      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${!!data ? getFormatedNumber(mergeMiseSolde(filtredMise)[1]) : ''}
        </span>
      </td>

      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${!!data ? getFormatedNumber(mergeMiseSolde(filtredMise)[2]) : ''}
        </span>
      </td>
    </tr>
    <tr>
        <td class="tg-l470" colspan="3">
        <span style="font-weight:800;font-style:normal;font-size:11pt;"> Total/Générale </span>
      </td>
      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${
...
const createRowFooterCredit = (data, dates, transCategory) => {
  const filtredMise = filterTransactions(mergreMise(data), dates, 'addDate');

  return `
    <tr>
      <td class="tg-l470" colspan="3">
        <span style="font-weight:800;font-style:normal">Total/Periodique</span>
      </td>
      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${
    ...
    <tr>
      <td class="tg-l470" colspan="3">
        <span style="font-weight:800;font-style:normal">Total/Générale </span>
      </td>
      <td class="tg-lvqx">
        <span style="font-weight:700;font-style:normal">
          ${
...
const createTable = ({admin, mise}, dates, transCategory) => {
  ...
  return !!filtredMise?.length
    ? `
        ...
        <tr class="label">
          <th class="tg-9gfu center" rowspan="2" colspan="3"></th>
  ...
  return !!filtredMise?.length
    ? `
        ...
        <tr>
          ...
          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${!!mise ? getFormatedNumber(getTotalDocumentFees(mise)[0]) : ''}
            </span>
          </td>
          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${!!mise ? getFormatedNumber(getTotalDocumentFees(mise)[1]) : ''}
            </span>
          </td>

          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${!!mise ? getFormatedNumber(getTotalDocumentFees(mise)[2]) : ''}
            </span>
          </td>
          ...
          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${
                !!mise
                  ? getFormatedNumber(
                      mergeMiseSolde(mise)[0] - getTotalDocumentFees(mise)[0],
                    )
                  : ''
              }
            </span>
          ...
          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${
                !!mise
                  ? getFormatedNumber(
                      mergeMiseSolde(mise)[1] - getTotalDocumentFees(mise)[1],
                    )
                  : ''
              }
            </span>
          ...
          <td class="tg-lvqx">
            <span style="font-weight:700;font-style:normal">
              ${
                !!mise
                  ? getFormatedNumber(
                      mergeMiseSolde(mise)[2] - getTotalDocumentFees(mise)[2],
                    )
                  : ''
              }
            </span>
    ...
    <body>
      <div id="header">
        <div class="title">
          ...
          <h3>
            BALANCE GLOBALE DES ${
              transCategory === 'E' ? 'MISES' : 'INTERÊTS'
            }<br />DU
      ...
      <table class="tg">    
        ...
        ${
          !!data && transCategory === 'E'
            ...
            : createRowFooterCredit(data, dates, transCategory)
        }
